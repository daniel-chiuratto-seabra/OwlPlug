...
public class SourceMenuController extends BaseController {
    ...
    private final NewSourceDialogController newSourceDialogController;
    private final ExploreService exploreService;

    @FXML private VBox sourceListHolder;
    @FXML private Pane newSourceMenuItem;

    public SourceMenuController(final ApplicationDefaults applicationDefaults, final ApplicationPreferences applicationPreferences,
                                final TelemetryService telemetryService, final DialogManager dialogManager, final MainController mainController,
                                final ExploreController exploreController, @Lazy final NewSourceDialogController newSourceDialogController,
        ...
        this.newSourceDialogController = newSourceDialogController;
