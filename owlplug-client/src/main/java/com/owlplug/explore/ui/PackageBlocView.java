...
public class PackageBlocView extends AnchorPane {
     ...
     */
    public PackageBlocView(final ApplicationDefaults applicationDefaults, final RemotePackage remotePackage, final Image image,
                           final ExploreController parentController) {
        super();
