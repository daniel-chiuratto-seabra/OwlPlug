...
public class WelcomeDialogController extends AbstractDialogController {
    ...
    WelcomeDialogController(final ApplicationDefaults applicationDefaults, final ApplicationPreferences applicationPreferences,
                            final TelemetryService telemetryService, final DialogManager dialogManager,
                            final LazyViewRegistry lazyViewRegistry, final PluginTaskFactory taskFactory,
                            @Lazy final OptionsController optionsController, @Lazy final ListDirectoryDialogController listDirectoryDialogController) {
        super(applicationDefaults, applicationPreferences, telemetryService, dialogManager, 700, 300);
    ...
    protected DialogLayout getLayout() {
        ...
        ImageView iv = new ImageView(getApplicationDefaults().rocketImage);
        iv.setFitHeight(20);
        iv.setFitWidth(20);
        title.setGraphic(iv);
