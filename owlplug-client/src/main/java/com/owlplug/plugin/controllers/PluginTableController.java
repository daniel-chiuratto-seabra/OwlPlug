...
import com.owlplug.project.controllers.common.TableColumnUtils;
...
public class PluginTableController extends BaseController {
    ...
    public PluginTableController(final ApplicationDefaults applicationDefaults, final ApplicationPreferences applicationPreferences,
                                 final TelemetryService telemetryService, final DialogManager dialogManager,
                                 @Lazy final PluginsController pluginsController, final DisablePluginDialogController disableController,
    ...
    private void createColumns() {
        ...
        formatColumn.setCellFactory(tableColumn -> cellFactory(tableColumn, getApplicationDefaults()));

        TableColumn<Plugin, String> manufacturerColumn = new TableColumn<>("Manufacturer");
        manufacturerColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getManufacturerName()));
        ...
        tableView.getColumns().addAll(asList(formatColumn, nameColumn, versionColumn,
    ...
    private ContextMenu createPluginContextMenu(Plugin plugin) {
        ...
        if (plugin.isDisabled()) {
            ...
            disableItem.setOnAction(e -> {
                if (this.getApplicationPreferences().getBoolean(ApplicationDefaults.SHOW_DIALOG_DISABLE_PLUGIN_KEY, true)) {
