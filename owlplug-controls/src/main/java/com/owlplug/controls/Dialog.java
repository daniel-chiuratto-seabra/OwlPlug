 ...
 * Simplified version based on JFXDialog from the JFoenix library.
 */
public class Dialog extends StackPane {
    ...
    private void initialize() {
        ...
        // ensure the holder is never resized beyond it's preferred size
    ...
    /**
     * if sets to true, the content of the dialog container will be cached and replaced with an image
     * when displaying the dialog (better performance).
     * this is recommended if the content behind the dialog does not change during the showing
     * period
     */
    ...
    private class LeftTransition extends CachedTransition {
        LeftTransition() {
            ...
            // reduce the number to increase the shifting, increase the number to reduce shifting
